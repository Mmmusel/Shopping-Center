...
<script>
  ...
  import TipsDialog from "@/components/rubbish/TipsDialog";
  import FormNavigation from "@/components/rubbish/FormNavigation";
  import ButtonRender from "@/components/rubbish/ButtonRender";
  import FilterNavigation from "@/components/rubbish/FilterNavigation";
